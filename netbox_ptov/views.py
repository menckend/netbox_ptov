...
def golab(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.add_message(request, messages.INFO, 'Switch-list: ' + str(swl)t, extra_tags='safe')
            ...
            messages.add_message(request, messages.INFO, 'GNS3 server: ' + str(srv)t, extra_tags='safe')
