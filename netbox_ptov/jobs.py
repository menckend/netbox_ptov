...
class ptovJob(JobRunner):
    ...
    def run(self, **kwargs):
        ...
        try:
            ...
            messages.info(obj.get_absolute_url, f"Virtual lab created successfully: {result_out}")
            return result_out
        except Exception as e:
            messages.error(obj.get_absolute_url, f'An error occurred: {str(e)}', extra_tags='safe')
            raise
